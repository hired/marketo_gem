...
module Rapleaf
  module Marketo
    def self.new_client(access_key, secret_key, api_subdomain = 'na-i', api_version = '2_9', document_version = '2_9')
    ...
    class Client
      ...
      def get_multi_leads_by_idnum(*idums)
        get_multi_leads(LeadKeys.new(LeadKeyType::IDNUM, *idums))
      end
